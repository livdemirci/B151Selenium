...
public class C01_ClassWork {
    public static void main(String[] args) throws InterruptedException {
        ...
        //==>(//*[text()=.])[11] Bu sekilde text ile aldigimiz bir xpath'a text degisse bile biz o webelementi
        // handle edebiliriz.
...
//wEB ELEMENTIN GORUNUR OLUP OLMDAGI DOGRULAMA
        if (sonucYazisi.isEnabled()){
            System.out.println("TEST PASSED");
        }else {
            System.out.println("TEST FAILED");
        }
